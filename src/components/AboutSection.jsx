    ...
    <section id="about" className="py-20">
      ...
      <div className="mx-auto w-[90vw] lg:grid lg:w-[95vw] lg:max-w-[1170px] lg:grid-cols-2 lg:gap-x-10">
        <div className="mb-8 lg:relative lg:mb-0">
          <div className="xl:before:absolute xl:before:-left-6 xl:before:-top-6 xl:before:-z-10 xl:before:box-border xl:before:h-full xl:before:w-full xl:before:border-8 xl:before:border-primary-4">
